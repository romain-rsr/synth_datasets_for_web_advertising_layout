...
This repository contains two synthetic datasets that allow for the training and the evaluation of learning models on generation of advertising layouts, even in the case where no real training samples are available.
...
Both datasets can be created, loaded, and displayed through the data_processing_tools jupyter notebook.
