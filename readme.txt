...
This repository contains two synthetic datasets of 100,000 samples each and a small real cases dataset of 93 samples. These datasets allow for the training and the evaluation of learning models on generation of advertising layouts, even in the case where no real training samples are available on your side.
...
In this dataset, most of the layouts have been created randomly within general constraints, while a minority of other layouts in this dataset have been created through specific rules. Each specific rule is applied to layouts where the colors of the elements match a specific sequence.
